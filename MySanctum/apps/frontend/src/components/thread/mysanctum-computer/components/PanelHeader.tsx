...
import { ViewType } from '@/stores/mysanctum-computer-store';
    ...
    return (
      <div className="h-14 flex-shrink-0 px-4 flex items-center justify-between border-b border-border">
        <div className="flex items-center">
          <Image
            src="/mysanctum-computer-white.svg"
            alt="MySanctum Computer"
            width={140}
            height={16}
          ...
          />
          <Image
            src="/mysanctum-computer-black.svg"
            alt="MySanctum Computer"
            width={140}
            height={16}
            ...
            priority
          />
          <DrawerTitle className="sr-only">MySanctum Computer</DrawerTitle>
        </div>
