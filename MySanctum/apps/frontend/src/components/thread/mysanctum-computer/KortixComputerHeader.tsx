...
interface MySanctumComputerHeaderProps {
...
/**
 * Shared header component for all MySanctum Computer views (Files, File Viewer, Browser).
 ...
 */
export function MySanctumComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
