...
export function SimpleFooter() {
  ...
  const { formattedStars, loading: starsLoading } = useGitHubStars('mysanctum-ai', 'suna');
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                href="https://www.linkedin.com/company/mysanctum/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="p-2 rounded-lg bg-muted/50 hover:bg-muted transition-colors group"
        ...
        <div className="mt-12 pt-8 border-t border-border/40">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © {currentYear} MySanctum. All rights reserved.
            </p>
