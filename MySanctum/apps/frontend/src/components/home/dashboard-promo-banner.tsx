...
export function DashboardPromoBanner() {
  ...
  // Show Welcome Bonus promo or MYSANCTUM26 for free tier users
  const shouldShowPromo = promo?.isActive && (promo.promoId === 'welcome-bonus' || promo.promoCode === 'MYSANCTUM26');
