      ...
      <Dialog open={authDialogOpen} onOpenChange={setAuthDialogOpen}>
        ...
        <DialogContent className="sm:max-w-md rounded-xl bg-background border border-border">
          ...
          <div className="mt-8 text-center text-[13px] text-muted-foreground leading-relaxed">
            ...
            <a href="https://www.mysanctum.com/legal?tab=terms" target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-foreground underline underline-offset-2 transition-colors">
              {tAuth('termsOfService')}
            </a>{' '}
            and{' '}
            <a href="https://www.mysanctum.com/legal?tab=privacy" target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-foreground underline underline-offset-2 transition-colors">
              {tAuth('privacyPolicy')}
            </a>
          </div>
        </DialogContent>
