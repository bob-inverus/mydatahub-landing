...
import { MySanctumIcon } from './mysanctum-logo';
...
export function MySanctumEnterpriseModal({
  children,
  open: controlledOpen,
          ...
          <div className="p-6 lg:p-8 flex flex-col bg-white dark:bg-black relative h-full overflow-y-auto border-r border-gray-200 dark:border-gray-800">
            <div className="relative z-10 flex flex-col h-full">
              <div className="mb-6 flex-shrink-0">
                <MySanctumIcon size={30} variant="logomark" />
              </div>
          ...
          <div className="bg-white dark:bg-[#171717] h-full overflow-hidden">
            <div className="h-full overflow-auto">
              <Cal
                ...
                calLink="team/mysanctum/enterprise-demo"
...
export const MySanctumProcessModal = MySanctumEnterpriseModal;
