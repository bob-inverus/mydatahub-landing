...
import { Library, Menu, Plus, Zap, MessageCircle, PanelLeftOpen, PanelLeftClose, Search, Users, Shield, Database } from 'lucide-react';
        ...
        >
          <div className="px-6 pt-4 space-y-4">
            ...
            <div className="w-full">
              ...
              >
                <Link
                  href="/dashboard"
                  onClick={() => {
                    posthog.capture('new_vault_action_clicked');
                    if (isMobile) setOpenMobile(false);
                  }}
                >
            ...
            <div className="flex justify-between items-center gap-2">
              {[
                { view: 'chats' as const, icon: Database, label: 'Vault' },
                { view: 'workers' as const, icon: Users, label: 'Agents' },
                { view: 'starred' as const, icon: Shield, label: 'Security' }
