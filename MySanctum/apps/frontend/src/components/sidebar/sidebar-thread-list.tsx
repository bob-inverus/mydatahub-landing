            ...
            {isLoading ? (
                  ...
                  <div className="px-3 py-3 mt-2">
                    <div className="flex items-center justify-center gap-4">
                      ...
                      <span className="text-xs text-muted-foreground flex items-center gap-1.5 tabular-nums">
                        {isThreadsFetching && <MySanctumLoader size="small" />}
              ...
              <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
                ...
                <p className="text-sm font-medium text-muted-foreground mb-1">
                  {mode === 'chats' ? 'Your vault is empty' : 'No activity yet'}
                </p>
                <p className="text-xs text-muted-foreground/60">
                  {mode === 'chats'
                    ? 'Add data to your secure vault to get started'
                    : 'Add data to your vault to see activity here'}
                </p>
              </div>
            )}
          </>
