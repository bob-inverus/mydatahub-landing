...
export function VoiceInput({
  ...
  const listening = externalListening !== undefined ? externalListening : _listening
  const time = externalTime !== undefined ? externalTime : _time
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      <motion.div
        className="flex p-2 border items-center justify-center rounded-full cursor-pointer bg-card"
        layout
        transition={{
          layout: {
            duration: 0.4,
