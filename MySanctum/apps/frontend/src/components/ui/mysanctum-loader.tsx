...
/**
 * MySanctumLoader - A unified circular loading animation component
 * 
 ...
 * <MySanctumLoader variant="white" />
 * 
 * // Always black (for light backgrounds in any theme)
 * <MySanctumLoader variant="black" />
 * 
 * // Custom size
      ...
      <div
        style={{
          ...
          animation: autoPlay && loop 
            ? `mysanctum-spin ${animationDuration}s linear infinite` 
            : autoPlay 
              ? `mysanctum-spin ${animationDuration}s linear` 
              : 'none',
        }}
      />
      <style jsx>{`
