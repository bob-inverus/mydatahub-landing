...
type Tone = 'light' | 'medium' | 'dark' | 'blue';
    ...
    const { c1, c2, c3 } =
        {
            ...
            blue: { c1: '#A8C8FF', c2: '#B8D4FF', c3: '#4A90FF' },
        }[tone];
...
const RightArc = ({
    ...
    const sw = 532;
    const sh = 657;
    const c = { light: '#D9D9D9', medium: '#C9C9C9', dark: '#B9B9B9', blue: '#B8D4FF' }[tone];
        ...
        return (
            ...
            >
                ...
                <div 
                    ...
                    style={{
                        background: 'radial-gradient(ellipse at 20% 30%, rgba(200, 200, 200, 0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 40%, rgba(168, 200, 255, 0.12) 0%, transparent 45%)'
                    }}
                />
                {variant === 'hero' && (
