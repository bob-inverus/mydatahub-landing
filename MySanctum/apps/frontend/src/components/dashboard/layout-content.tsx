...
const MySanctumAppBanners = lazy(() => 
  import('@/components/announcements/mysanctum-app-banners').then(mod => ({ default: mod.MySanctumAppBanners }))
);
  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* MySanctum App announcement banners */}
        <Suspense fallback={null}>
          <MySanctumAppBanners disableMobileAdvertising={featureFlags.disableMobileAdvertising} />
        </Suspense>
