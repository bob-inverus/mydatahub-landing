...
const STORAGE_KEY = 'mysanctum-mobile-banner-dismissed';
...
function MySanctumIcon({ className }: { className?: string }) {
  return (
          ...
          >
            <div className="p-5 flex items-center gap-4">
              ...
              <div className="w-14 h-14 bg-black dark:bg-white rounded-xl flex items-center justify-center flex-shrink-0">
                <MySanctumIcon className="w-7 h-7 text-white dark:text-black" />
              </div>

              {/* Text */}
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-semibold text-neutral-900 dark:text-white mb-0.5">
                  Get MySanctum for Mobile
                </h3>
