      ...
      <div className={cn(
        ...
        {tier.features && tier.features.length > 0 && (
          <ul className="space-y-2 sm:space-y-3">
                    ...
                    <li key={feature} className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-1 sm:gap-1.5">
                          ...
                          <MySanctumIcon size={12} variant="symbol" className="hidden sm:block" />
              ...
              // Special handling for MySanctum Advanced mode - show with Basic crossed out
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                        ...
                        <span className="inline-flex items-center gap-1 sm:gap-1.5 px-1.5 sm:px-2 py-0.5 bg-primary/10 dark:bg-primary/15 rounded-md">
                          <MySanctumIcon size={10} variant="symbol" className="sm:hidden" />
                          <MySanctumIcon size={12} variant="symbol" className="hidden sm:block" />
              ...
              if (feature.includes('private project')) {
                ...
                translatedFeature = 'MySanctum Advanced mode';
