                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <div className="text-muted-foreground mb-6 space-y-2">
                        <p>
                          <strong>MySanctum AI Corp</strong>
                        </p>
                      ...
                      <div className="text-muted-foreground mb-6">
                        <p>
                          Email:{' '}
                          <a
                            href="mailto:info@mysanctum.com"
                      ...
                      <p className="text-muted-foreground mb-6">
                        MySanctum AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY MySanctum AI
                        Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                        United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE MySanctum
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to MySanctum AI Corp (701 Tillery Street
                          Unit 12-2521 Austin, Texas 78702, United States).
                        </li>
                        <li>
                          "Site" refers to the MySanctum website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the MySanctum website and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@mysanctum.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/mysanctum-ai/suna/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/mysanctum-ai/suna/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@mysanctum.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@mysanctum.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All MySanctum logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE MySanctum WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        MySanctum DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at MySanctum in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        MySanctum does not collect biometric or identifying
