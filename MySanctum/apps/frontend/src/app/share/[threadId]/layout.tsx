...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | MySanctum',
    description: 'Replay this Worker conversation on MySanctum',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | MySanctum';
    const description =
      projectData.description ||
      'Replay this Worker conversation on MySanctum';
