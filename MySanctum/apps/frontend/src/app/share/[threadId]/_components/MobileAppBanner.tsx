...
export function MobileAppBanner({ threadId }: MobileAppBannerProps) {
  ...
  const handleOpenInApp = () => {
    ...
    const appUrl = `mysanctum://share/${threadId}`;
    ...
    setTimeout(() => {
      if (platform === 'ios') {
        window.location.href = 'https://apps.apple.com/app/mysanctum/id6739583417';
      } else if (platform === 'android') {
        window.location.href = 'https://play.google.com/store/apps/details?id=com.mysanctum.app';
      }
    }, 2000);
  };
      ...
      <div className="bg-background/95 backdrop-blur-md border-b border-border/50 px-3 py-2.5 safe-area-top">
        <div className="flex items-center gap-3">
          ...
          <div className="shrink-0 w-10 h-10 rounded-xl bg-foreground flex items-center justify-center">
            <MySanctumIcon size={20} className="invert dark:invert-0" />
          </div>
