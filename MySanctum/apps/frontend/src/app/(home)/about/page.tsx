...
const paragraphs: ParagraphItem[] = [
  "We're MySanctum. Eight people, no office.",
        ...
        <div className="mt-24 md:mt-32">
          ...
          <div className="md:hidden border border-foreground/10 rounded-sm p-6">
            ...
            <div className="text-center mt-6">
              <Image src="/mysanctum-symbol.svg" alt="MySanctum" width={16} height={13} className="inline-block opacity-20 dark:invert" />
            </div>
          </div>
