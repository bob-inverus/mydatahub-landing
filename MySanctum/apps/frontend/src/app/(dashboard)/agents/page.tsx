...
export default function AgentsPage() {
  ...
  const [marketplaceFilter, setMarketplaceFilter] = useState<'all' | 'mysanctum' | 'community' | 'mine'>('all');
  ...
  const marketplaceQueryParams = useMemo(() => {
    ...
    if (marketplaceFilter === 'mysanctum') {
      params.is_mysanctum_team = true;
    } else if (marketplaceFilter === 'community') {
      params.is_mysanctum_team = false;
    ...
    if (marketplaceTemplates?.templates) {
      marketplaceTemplates.templates.forEach(template => {
        const item: MarketplaceTemplate = {
          ...
          is_mysanctum_team: template.is_mysanctum_team,
