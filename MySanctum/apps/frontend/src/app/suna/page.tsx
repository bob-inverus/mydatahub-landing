...
export const metadata: Metadata = {
  title: 'Suna is now MySanctum | MySanctum Suna - Open Source AI Worker',
  description: 'Suna has rebranded to MySanctum. MySanctum (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'MySanctum Suna',
    'Suna AI',
  ...
  openGraph: {
    title: 'Suna is now MySanctum',
    description: 'MySanctum (formerly Suna) - Same powerful open source AI worker, new name.',
    type: 'website',
    url: 'https://www.mysanctum.com/suna',
    siteName: 'MySanctum',
    images: [
      {
        url: '/banner.png',
  ...
  alternates: {
    canonical: 'https://www.mysanctum.com/suna',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'MySanctum',
            alternateName: ['Suna', 'MySanctum Suna', 'Suna AI'],
            url: 'https://www.mysanctum.com',
            logo: 'https://www.mysanctum.com/favicon.png',
            sameAs: [
              'https://github.com/mysanctum-ai',
              'https://x.com/mysanctum',
              'https://linkedin.com/company/mysanctum',
            ],
            description:
              'MySanctum (formerly known as Suna) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.mysanctum.com',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Suna is now MySanctum',
                item: 'https://www.mysanctum.com/suna',
              },
            ],
          }),
        }}
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
              ...
              <div className="relative mb-8 sm:mb-12" style={{ width: '80px', height: '80px' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.6,
                    maskImage: 'url(/mysanctum-symbol.svg)',
                    WebkitMaskImage: 'url(/mysanctum-symbol.svg)',
                    maskSize: 'contain',
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-3xl mx-auto px-2 sm:px-0 pb-16">
              ...
              <a
                href="https://github.com/mysanctum-ai/suna"
                target="_blank"
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Suna to MySanctum</p>
                  <p>Our domain is now mysanctum.com</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-base md:text-lg text-muted-foreground font-medium">
                  Our GitHub repository remains at github.com/mysanctum-ai/suna
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. MySanctum is the evolution of Suna — the same open
              ...
              Suna", or "MySanctum Suna" — this is the official continuation of the Suna project under
              the MySanctum brand.
            </p>
          </div>
        </div>
