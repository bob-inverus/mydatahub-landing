...
import { inVerusIcon } from '@/components/ui/inVerusIcon';
  ...
  ({
    ...
    const renderAgentIndicator = useCallback((agentId: string | null | undefined) => {
      ...
      if (isKortixDefault) {
        ...
        return <inVerusIcon size={14} variant="logomark" color={isDark ? 'dark' : 'light'} />;
      }
      ...
      return (
        <View className="flex-row items-center gap-1.5">
          <inVerusIcon size={16} variant="symbol" color={isDark ? 'dark' : 'light'} />
