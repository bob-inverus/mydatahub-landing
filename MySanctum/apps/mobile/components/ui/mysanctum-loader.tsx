...
interface MySanctumLoaderProps {
  /**
...
/**
 * MySanctumLoader - A unified loading animation component
 * 
 ...
 * 
 * // Custom size
 * <MySanctumLoader size="large" />
 * 
 * // Force dark theme (white loader)
 * <MySanctumLoader forceTheme="dark" />
 * 
 * // With ref for manual control
 * const lottieRef = useRef<LottieView>(null);
 * <MySanctumLoader lottieRef={lottieRef} autoPlay={false} />
 * ```
 */
export function MySanctumLoader({
  size = 'medium',
  speed = 1.2,
  customSize,
  className,
...
// Keep backwards compatibility with KortixLoader
export { MySanctumLoader as KortixLoader };
