...
Environment Variables (add to .env):
    ...
    PROD_SUPABASE_SERVICE_ROLE Production service role key
...
async def main():
    ...
    prod_key = os.getenv('PROD_SUPABASE_SERVICE_ROLE')
    ...
    if not prod_url or not prod_key:
        ...
        print("  export PROD_SUPABASE_SERVICE_ROLE='...'")
    ...
    staging_key = config.SUPABASE_SERVICE_ROLE
